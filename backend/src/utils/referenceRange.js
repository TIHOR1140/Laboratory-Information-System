/**
 * Backend helper to evaluate if a result value falls within normal limits according to reference_range.
 */
function checkIsNormal(valueStr, referenceRangeStr) {
  ...
  // 1. Min - Max range (e.g., "70 - 99", "13.0 - 17.5")
