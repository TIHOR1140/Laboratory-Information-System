    ...
    >
      {success ? (
        <div className="rounded-2xl border border-green-200 bg-green-50 p-6 text-center shadow-sm">
          ...
          <h3 className="mb-2 text-lg font-semibold text-green-800">Check your inbox</h3>
          <p className="text-sm text-green-700">{message}</p>
          <Link
            to="/login"
            className="mt-6 inline-block text-sm font-semibold text-green-700 hover:text-green-800 underline"
          >
            Return to Login
          </Link>
        </div>
