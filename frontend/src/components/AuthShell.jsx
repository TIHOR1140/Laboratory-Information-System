export function AuthShell({ eyebrow, title, subtitle, children }) {
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 bg-gradient-to-tr from-slate-100 via-blue-50/30 to-blue-50/60 dark:from-slate-900 dark:via-slate-950 dark:to-slate-950 font-sans transition-colors duration-200">
      ...
      <div className="relative w-full max-w-xl animate-in fade-in slide-in-from-bottom-4 duration-350">
        <section className="flex items-center justify-center">
          <div className="w-full rounded-3xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xl sm:p-8">
            <p className="text-xs font-bold uppercase tracking-[0.25em] text-blue-600 dark:text-blue-400">{eyebrow}</p>
            <div className="mt-3">
